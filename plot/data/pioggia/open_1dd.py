...
Infact, if you clone the above that archive (../1dd-v1.2/),
unzip all the files and just run this file (python open_1dd.py)
it should just work; at the end, a directory called 'proc/'
should contain the monthly average of each original file.
'''
...
def main(filename,metatable,outdir=''):
    ...
    data_filename = filename + '_data_monthlyMean.npy'
...
if __name__ == '__main__':
    ...
    '''
    import pandas
    df = pandas.DataFrame(columns=['year','month','file','missing_value','units'])

    from glob import glob
    fls = glob('gpcp_1dd_v1.2_p1d.*')
